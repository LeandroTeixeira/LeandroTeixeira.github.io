...
describe('13 - Crie a exibição de perfil', () => {
  ...
  it.skip('Será validado se a API getUser é usada para recuperar as informações da pessoa logada',
    async () => {
  ...
  it.skip('Será validado se as informações da pessoa logada são exibidas na tela',
    async () => {
      renderPath("/profile");
  ...
  it.skip('Será validado se foi criado um link para a rota de edição de perfil com o texto Editar perfil',
    async () => {
      renderPath("/profile");
  ...
  it.skip('Será validado se ao clicar no link Editar perfil, a navegação acontece corretamente',
    async () => {
      renderPath("/profile");
