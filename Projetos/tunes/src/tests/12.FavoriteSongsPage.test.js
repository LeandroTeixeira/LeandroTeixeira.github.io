...
describe('12 - Crie a lista de músicas favoritas', () => {
  ...
  it.skip('Será validado se a requisição para getFavoriteSongs é feita para recuperar as músicas favoritas',
    async () => {
  ...
  it.skip('Será validado se é exibida a lista de músicas favoritas',
    async () => {
      const favoriteSongs = [
        {
          trackId: '12',
  ...
  it.skip('Será validado se a lista de músicas favoritas é atualizada ao remover uma música da lista',
    async () => {
      const favoriteSongs = [
        {
          trackId: 12,
